	...
	<div class="grid gap-4 md:grid-cols-2 md:items-center md:gap-8 xl:gap-20">
		<div>
			...
			<p class="mt-3 text-lg text-gray-800 dark:text-neutral-400">
				Bringing your visions to life, one line of code at a time. <br /><br />I specialize in
				full-stack web development and automation, turning your ideas into powerful digital
				solutions.
			</p>
		...
		<div class="relative ms-4 bg-black">
			<!-- svelte-ignore a11y-img-redundant-alt -->
			<img class="w-full rounded-full" src="/developer.webp" alt="Hero Image" />
		</div>
	</div>
	<!-- End Grid -->
</div>
