...
<div>
	...
	<div class="group relative flex gap-x-5">
		...
		<div class="grow pb-8 group-last:pb-0">
			<h3 class="mb-1 text-xs text-gray-600 dark:text-neutral-400">2023 - Present</h3>
	...
	<div class="group relative flex gap-x-5">
		...
		<!-- Right Content -->
		<div class="grow pb-8 group-last:pb-0">
			<h3 class="mb-1 text-xs text-gray-600 dark:text-neutral-400">2021 - 2023</h3>
	...
	<div class="group relative flex gap-x-5">
		...
		<!-- Right Content -->
		<div class="grow pb-8 group-last:pb-0">
			<h3 class="mb-1 text-xs text-gray-600 dark:text-neutral-400">2011 - 2021</h3>
	...
	<div class="group relative flex gap-x-5">
		...
		<!-- Right Content -->
		<div class="grow pb-8 group-last:pb-0">
			<h3 class="mb-1 text-xs text-gray-600 dark:text-neutral-400">2010 - 2011</h3>
			...
			<ul class="ms-6 mt-3 list-disc space-y-1.5">
				...
				<li class="ps-1 text-sm text-gray-600 dark:text-neutral-400">
					Utilized tools such as Notion for project tracking, Mailchimp for email marketing designs,
					Slack for team collaboration, and GitHub for version control and project sharing.
				</li>
			</ul>
		</div>
		<!-- End Right Content -->
